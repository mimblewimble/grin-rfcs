# Grin RFCs - [Active RFC List](index.md)
...
to work very well. This document is currently a work in progress. It will be 
adjusted as needed before sharing with the wider community. If you are reading
this please leave your feedback!_
...
bit of a design process and produce a consensus among the Grin community and
the subteams.
...
[Table of Contents]: #table-of-contents
  ...
  the Grin codebase, Grin governance, or the RFC process itself. What constitutes a
...
RFCs must follow the specific guidelines established by their associated subteam(s). RFC-0001 (Grin Governance) will establish the process for initializing subteams. Subteam guidelines will be added here as available.
...
the idea in the projects Gitter chat, discussing the topic at grin-forum.org,
and occasionally posting "pre-RFCs" on the forum. You may file issues
...
In short, to get a major feature added to Grin, one must first get the RFC
...
"active" and may be implemented with the goal of eventual inclusion into Grin.
  ...
  - The FCP lasts ten calendar days, so that it is open for at least 5 business
    ...
    e.g. on the [Grin Forum](https://grin-forum.org/). This way all
    community members have a chance to lodge any final objections before a decision
    is reached.
...
feature as a pull request to the relevant Grin repo. Being "active" is not a rubber
...
it imply anything about whether a Grin developer has been assigned the task of
...
associated issue tracking its implementation in the relevant Grin repository; thus that
associated issue can be assigned a priority via the triage process that the
team uses for all issues in the Grin repository.
